# Visual Studio 2019 for Fortran development on Windows

- [Visual Studio 2019 for Fortran development on Windows](#visual-studio-2019-for-fortran-development-on-windows)
  - [Introduction](#introduction)
    - [Fortran compilers](#fortran-compilers)
    - [The Visual Studio IDE](#the-visual-studio-ide)
      - [__Key features__](#key-features)
      - [__Main drawbacks compared to other tools__](#main-drawbacks-compared-to-other-tools)
  - [Installation](#installation)
    - [Installing VS](#installing-vs)
  ...
  - [Compiling a complex code library](#compiling-a-complex-code-library)
    ...
    - [__Code with modules in a library__](#code-with-modules-in-a-library)
...
#### __Main drawbacks compared to other tools__
...
### __Code with modules in a library__
