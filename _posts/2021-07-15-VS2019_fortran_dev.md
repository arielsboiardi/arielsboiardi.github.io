...
description: A guide to Fortran development on Windows
tags: guide fortran coding numerics
categories: tutorial
---
...
- In `Project > Project Dependencies` we select `matrix` and in `Depends on` check `lib_static`
    ...
    {% include figure.liquid loading="eager" path="/assets/posts/Fortran_VS2019/deps1.png" title="Figure 1" class="img-fluid rounded z-depth-1" %}
...
- We can now open the main program source file and press `Start`
    ...
    {% include figure.liquid loading="eager" path="/assets/posts/Fortran_VS2019/compilation_log.png" title="Figure 1" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="/assets/posts/Fortran_VS2019/qomp.png" title="Figure 1" class="img-fluid rounded z-depth-1" %}
